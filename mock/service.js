...
export default [
  ...
  // change_pwd
  {
    ...
    type: 'get',
    response: config => {
      return { 'errno': 0, 'errmsg': '', 'data': { 'today': [78, 23, 78, 123, 325, 378, 456, 478, 500, 800, 760], 'yesterday': [120, 50, 10, 57, 59, 48, 76, 69, 200, 400, 580, 600, 640, 600, 550, 500, 580, 600, 640, 600, 500, 360, 200, 105] }, 'trace_id': '', 'stack': null }
    }
  }
]
