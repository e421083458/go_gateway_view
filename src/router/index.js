...
export const constantRoutes = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'service_list',
        component: () => import('@/views/service/service_list'),
        name: '服务列表',
